...
@main
struct PortfolioishWidget: Widget {
    let kind: String = "PortfolioishWidget"
...
struct PortfolioishWidget_Previews: PreviewProvider {
    static var previews: some View {
        PortfolioishWidgetEntryView(entry: SimpleEntry(date: Date(), configuration: ConfigurationIntent()))
